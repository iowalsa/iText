...
public interface RenderListener {
    ...
    //jjs: for drawing lines
    /**
     * Called when a line should be rendered
     * @param lineSegment information specifying what to render
     */
    public void renderLine(LineSegment lineSegment, float lineWidth);

    //end jjs: for drawing lines
